...
function preload(){
    userUpload = loadImage("rose.jpeg");
}
...
function draw(){
    ...
    for(var row = 0; row < height; row++){
        for(var col = 0; col < width; col++){
            ...
            if(key=="3"){
                pixels[startingIndex] = r;
                pixels[startingIndex + 1] = g + row - 190;
                pixels[startingIndex + 2] = b + col - 190;
                pixels[startingIndex + 3] = a;
            }
            if(key=="2"){
                pixels[startingIndex] = r;
                pixels[startingIndex + 1] = g + row - 500;
                pixels[startingIndex + 2] = b + col - 450;
                pixels[startingIndex + 3] = a;
            }
